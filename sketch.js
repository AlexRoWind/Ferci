...
function setup() {
  ...
  invisibleGround2 = createSprite(width / 2, height - 420,width, 50);
  invisibleGround2.visible = false;

  invisibleGround3 = createSprite(width / 365, height - 420,20, height);
 invisibleGround3.visible = false;

 invisibleGround4 = createSprite(width -2, height - 420,20, height);
